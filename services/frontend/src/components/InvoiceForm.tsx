  ...
  useEffect(() => {
    if (id && invoiceDetails) {
      ...
      if (invoiceDetails.invoice.status !== 'DRAFT') {
        ...
        const tempLineItems: LineItem[] =
          invoiceDetails.order.orderlines?.map(
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div>
                  <Label htmlFor="client" className="pb-1">
                    Client
                  </Label>
                  <ClientCombobox
              ...
              <div className="space-y-4">
                <div>
                  <Label htmlFor="invoice-number" className="pb-2">
                    Invoice Number
                  </Label>
                  <Input
                    id="invoice-number"
                ...
                <div>
                  <Label htmlFor="invoice-date" className="pb-2">
                    Invoice Date
                  </Label>
                  <Input
                    id="invoice-date"
                ...
                <div>
                  <Label htmlFor="due-date" className="pb-2">
                    Due Date
                  </Label>
                  <Input
                    id="due-date"
